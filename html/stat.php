			...
			<div>
				...
				{ ?>
					<tr>
						...
						<?php } else { ?>
							<td></td>
							<td><a href="<?php echo URL_BASE_ZORRO."/index.php?new&idmodel=".$post_selectarrete."&comp="."structures-".$ldap->getSupannCodeEntiteFromAPO($todo['cmp'])."&etp=".$todo['code']; ?>" target="_blank">Créer</a></td>
							<td></td>
						<?php } ?>
					</tr>
